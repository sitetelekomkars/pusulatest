...
// ESKİ window.updateRowScore kaldırıldı. YENİ setButtonScore kullanılıyor.
...
// YENİ: Dinamik puanlamayı ve not alanını yöneten fonksiyon
    ...
    try {
        ...
        if (data.result === "success") {
            ...
            filteredEvals.reverse().forEach((evalItem, index) => {
                ...
                // Edit butonu sadece ADMIN'e açık, QUsers'a kapalı
